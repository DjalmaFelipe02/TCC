# checkout_services.py (Flask)

from .subsystems import InventoryService, ShippingService, TaxService

class CheckoutFacade:
    """Facade para simplificar o processo de checkout (Versão Flask).
    ...
    A implementação é idêntica à versão do FastAPI, demonstrando a
    portabilidade da lógica do padrão entre frameworks.
    """
    def __init__(self):
