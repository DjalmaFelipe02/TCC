...
# --- Abstract Factory Concretas ---

class JsonProvider(SerializerProvider):
    """Abstract Factory para criar serializadores JSON.
...
# --- Função auxiliar para obter a fábrica concreta (Opcional, pode ser feito na rota) ---
